...
- Repo: `codepath/pathreview-ai301-fa26-s1` <!-- upstream classroom repo; Gourav-praneeth/pathreview-ai301-fa26-s1 is my personal fork (issues disabled there) where I open the PR from -->
...
<!-- DRAFT — Claude wrote this from course context since you asked for a starting
point; edit it so it actually describes you before you submit. -->
I'm most comfortable in Python, and I'm working through AI301 to get better at
reading unfamiliar codebases and shipping a real, reviewed pull request rather
than a toy project. For a first issue I'd like something with a clear bug and a
test I can point to, in a backend/service-layer file rather than deep frontend
or infra code I haven't touched yet. I'd rather avoid anything that requires
setting up infrastructure (CI, deployment) I can't easily run locally.
